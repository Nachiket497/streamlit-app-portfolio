...
st.set_page_config(page_title="PID Controller using Op-Amp",  page_icon="img/N.png")
...
st.markdown("<li><a href=https://github.com/Nachiket497/PID_Controller_using_OP-Amp>Github</a></li>" ,unsafe_allow_html=True )
