...
st.set_page_config(page_title="Cruise Controller",  page_icon="img/N.png", initial_sidebar_state="collapsed")
...
st.markdown("### Code: https://github.com/Nachiket497/CRUISE-CONTROLLER")
